...
public class LoginStrings {
    ...
    static var biometricLocked = "Too many failed attempts."
    static var biometricNotAvaible = "Biometric authentication is not available on the device"
    static var biometricNotEnrolled = "Biometric authentication is disabled on the device"
    ...
    static var thereIsntSensor = "This device does not have Biometric authentication configured."
